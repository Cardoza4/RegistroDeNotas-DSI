...
// Determinar cantidad de periodos reglamentarios (Bachillerato: 4, Básica/Tercer Ciclo: 3)
...
// Agrupar calificaciones por materia en matriz: [Materia][Periodo] = Promedio
$matrizNotas = [];
if (!empty($boleta)) {
...
// Retorno dinámico según el rol autenticado
$rolActual = strtolower($_SESSION['rol'] ?? '');
$urlRetorno = ($rolActual === 'estudiante' || $rolActual === 'alumno') 
    ? 'index.php?action=dashboard' 
    : 'index.php?action=notas';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        .boleta-sheet { max-width: 920px; margin: 25px auto; background: white; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.06); }
        .table-siges { border: 1px solid #94a3b8; font-size: 13.5px; margin-bottom: 0; }
        .table-siges th { background-color: #f8fafc; font-weight: 700; color: #1e293b; border: 1px solid #94a3b8; text-align: center; vertical-align: middle; padding: 8px; }
        .table-siges td { border: 1px solid #cbd5e1; vertical-align: middle; padding: 7px 10px; }
        .meta-box { border: 1px solid #94a3b8; border-collapse: collapse; font-size: 13px; width: 100%; }
        .meta-box td { border: 1px solid #cbd5e1; padding: 6px 12px; }
        .meta-label { font-weight: 700; background-color: #f8fafc; color: #475569; width: 170px; }
...
<body>
    ...
    <div class="container py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 no-print" style="max-width: 920px; margin: auto;">
            <a href="<?= $urlRetorno; ?>" class="btn btn-outline-secondary btn-sm fw-bold">
        ...
        <div class="boleta-sheet p-4 p-md-5 border">
            ...
            <div class="row align-items-center mb-4">
                ...
                <div class="col-10 text-center pe-md-5">
                    ...
                    <p class="text-muted mb-0 small text-uppercase">Departamento de Registro y Acreditación Académica</p>
            ...
            <table class="meta-box mb-4">
                ...
                <tr>
                    ...
                    <td colspan="3"><?= $esBachillerato ? 'Educación Media / Bachillerato' : 'Educación Básica / Tercer Ciclo'; ?></td>
                </tr>
                <tr>
                    ...
                    <td class="meta-label" style="width: 90px;">Año:</td>
                    <td style="width: 100px;"><strong>2026</strong></td>
                </tr>
                <tr>
                    <td class="meta-label">Grado Escolar:</td>
            ...
            <!-- Tabla de Calificaciones Horizontal Formato SIGES -->
            <div class="table-responsive mb-3">
                <table class="table table-siges align-middle">
                    <thead>
                        <tr>
                            <th class="text-start ps-3" style="width: 44%;">Componente plan de estudio</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($notaFinal !== null): ?>
                                    <span class="badge <?= $aprobado ? 'badge-aprobado' : 'badge-reprobado' ?> px-2 py-1">
                        ...
                        <tr class="fw-bold" style="background-color: #f8fafc; border-top: 2px solid #94a3b8;">
                            <td class="ps-3 text-uppercase text-secondary">Promedio Global Institucional</td>
